...
> **Python bindings are available** in [`crates/llms-sdk-py`](./crates/llms-sdk-py).
...
See [`crates/llms-sdk-py/README.md`](./crates/llms-sdk-py/README.md) for python examples and API docs.
