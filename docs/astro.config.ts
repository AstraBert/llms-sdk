...
const nimbusConfig = defineNimbusConfig({
  ...
  description: "A unified interface to call LLM APIs, written in Rust.",
  locale: "en",
  github: "https://github.com/AstraBert/llms-sdk",
  socialImageAlt: "llms-sdk🦀",
});
